...
\usepackage{amsmath, amsthm, amssymb, graphicx, setspace, newtxtext, listings}
\graphicspath{ {./images/} }
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{images/HistOriginal.png} %expHistDefault, %expDensityDefault
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{images/vL.png} %expHistDefaultA, %expDensityDefaultA
  \caption{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{images/vL.png} %expHistModifiedA, %expDensityModifiedA
  \caption{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{images/vL.png} %expDensitySmallA
  \caption{}
\end{figure}
